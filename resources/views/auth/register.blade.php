    ...
    <div class="flex min-h-full items-center justify-center p-6 lg:p-8">
        <div class="w-full max-w-md">
            ...
            <div class="mb-10 text-center animate-in fade-in slide-in-from-top-4 duration-1000">
                ...
                <h1 class="text-3xl font-bold tracking-tight text-blue-600 dark:text-white mb-2">Create Account</h1>
            ...
            <div class="relative animate-in zoom-in-95 duration-700 delay-150">
                ...
                <div class="relative bg-slate-900/10 dark:bg-slate-900/60 backdrop-blur-3xl px-8 py-8 shadow-2xl rounded-3xl border border-white/10">
                    <form class="space-y-3" action="{{ route('register.store') }}" method="POST">
                        @csrf
                        <div class="space-y-2">
                            <label for="name" class="text-sm font-medium text-blue-600 dark:text-slate-300 ml-1">Full Name</label>
                        ...
                        <div class="grid grid-cols-1 gap-5">
                            <div class="space-y-2">
                                <label for="password" class="text-sm font-medium text-blue-600 dark:text-slate-300 ml-1">Password</label>
                                <input id="password" name="password" type="password" required
                                    class="w-full bg-slate-400 dark:bg-slate-950/50 border border-white/10 rounded-xl py-3 px-4 text-white placeholder-slate-300 dark:placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 transition-all duration-300"
                                    placeholder="••••••••">
                            </div>
                            <div class="space-y-2">
                                <label for="password_confirmation" class="text-sm font-medium text-blue-600 dark:text-slate-300 ml-1">Confirm</label>
